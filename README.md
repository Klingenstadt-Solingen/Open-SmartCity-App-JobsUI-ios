<div style="display:flex;gap:1%;margin-bottom:20px">
  <h1 style="border:none">Open SmartCity Jobs UI Module of the Open SmartCity App</h1>
...
* copy `Development.xcconfig` and `Production.xcconfig` to `OSCAJobsUI/OSCAJobsUI/SupportingFiles`, these files have to be ignored by git

### Deeplinking
|                |                                            |
|---             |---                                         |
| Jobs overview: | `{scheme}://jobs/`                         |
| Jobs detail:   | `{scheme}://jobs/detail?object={objectId}` |
## Other
